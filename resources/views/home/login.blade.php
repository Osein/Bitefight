                                ...
                                <form id="loginForm" name="loginForm" method="POST">
                                    ...
                                    <table cellpadding="2" cellspacing="2" border="0" width="100%">
                                        <tr>
                                            ...
                                            <td><input class="input" type="text" name="user" size="32" MAXLENGTH="32" value="{{ old('user') }}" autofocus></td>
                                        </tr>
                                        <tr>
                                            <td>{{__('general.password')}}:</td>
                                            <td><input class="input" type="password" name="pass" size="20" MAXLENGTH="20">
                                                <br />
